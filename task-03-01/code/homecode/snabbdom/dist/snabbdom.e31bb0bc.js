...
},{"./vnode":"node_modules/snabbdom/vnode.js","./is":"node_modules/snabbdom/is.js"}],"index.js":[function(require,module,exports) {
...
var wordArr = 'ABCDEFGHIJKLMNOBQRST'.split(''); // 原始数据

var data = wordArr.slice(0, 5).map(function (word, i) {
  return {
    'rank': i + 1,
    'title': word,
    'desc': 'This is ' + word
...
function initVnode(data) {
  ...
  }, [h('tr', [h('th', '序号'), h('th', '标题'), h('th', '描述')]), h('tbody', data.map(getTrVnode))])]);
} // 保存 vnode


var vnode = initVnode(data); // 首次渲染

patch(app, vnode); // 设置当行内容

function getTrVnode(item) {
  return h('tr', [h('td', item.rank), h('td', item.title), h('td', item.desc)]);
} // 点击按钮，改变排序
...
},{"snabbdom":"node_modules/snabbdom/es/snabbdom.js","snabbdom/modules/class":"node_modules/snabbdom/modules/class.js","snabbdom/modules/props":"node_modules/snabbdom/modules/props.js","snabbdom/modules/style":"node_modules/snabbdom/modules/style.js","snabbdom/modules/eventlisteners":"node_modules/snabbdom/modules/eventlisteners.js","snabbdom/h":"node_modules/snabbdom/h.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
